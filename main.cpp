...
void scalar_mult(double k, Matrix m1, Matrix &scalar) {
  scalar.r1c1 = k * m1.r1c1;
  scalar.r1c2 = k * m1.r1c2;
  scalar.r2c1 = k * m1.r2c1;
  scalar.r2c2 = k * m1.r2c2;
}
void calc_prod(Matrix m1, Matrix m2, Matrix &prod) {
  prod.r1c1 = (m1.r1c1 * m2.r1c1) + (m1.r1c2 * m2.r2c1);
  prod.r1c2 = (m1.r1c1 * m2.r1c2) + (m1.r1c2 * m2.r2c2);
  prod.r2c1 = (m1.r2c1 * m2.r1c1) + (m1.r2c2 * m2.r2c1);
  prod.r2c2 = (m1.r2c1 * m2.r1c2) + (m1.r2c2 * m2.r2c2);
}
...
void display_menu(string MENU) {
  cout << "\nWelcome! What would you like to calculate between the matrices?"
       << endl
       << "1. Sum" << endl
       << "2. Difference" << endl
...
void menu_selection(int &selection) { cin >> selection; }
...
void out_selection(int &num) {
  cout << "Choose one of the following: (1)Print to Screen / (2)Print to "
          "Outfile / (3)Print to Both"
       << endl;
  cin >> num;
}
void out_validation(int &num) {
  while (num < 1 || num > 3) {
    cout << "\n**ERROR** Option not valid\n"
         << "\nChoose one of the following: (1)Print to Screen / (2)Print to "
            "Outfile / (3)Print to Both"
         << endl;
    cin >> num;
  }
...
void new_matrix_menu(int &select) {
  cout << "Do you want to enter a new scalar value and new matrices? Enter 0"
       << endl
...
void out_print(int num, Matrix &m, string name, ofstream &outfile) {
  ...
  case 1:
    ...
    cout << setw(13) << left << "--" << setw(10) << left << setw(10) << "--"
         << endl;
    cout << left << "| " << m.r1c1 << setw(10) << right << setw(10) << m.r1c2
         << " |" << endl;
    cout << left << "| " << setw(10) << right << setw(13) << " |" << endl;
    cout << left << "| " << m.r2c1 << setw(10) << right << setw(10) << m.r2c2
         << " |" << endl;
    cout << setw(13) << left << "--" << setw(10) << left << setw(10) << "--"
         << endl;
    break;
  case 2:
    ...
    outfile << setw(13) << left << "--" << setw(10) << left << setw(10) << "--"
            << endl;
    outfile << left << "| " << m.r1c1 << setw(10) << right << setw(10) << m.r1c2
            << " |" << endl;
    outfile << left << "| " << setw(10) << right << setw(13) << " |" << endl;
    outfile << left << "| " << m.r2c1 << setw(10) << right << setw(10) << m.r2c2
            << " |" << endl;
    outfile << setw(13) << left << "--" << setw(10) << left << setw(10) << "--"
            << endl;
    break;
